...
$sql = "SELECT codigo_tarea, casuistica, procedencia, solicitante, segmento,
ramo, da, asunto, color, fecha_asignacion, dias_habiles, observacion,
calificacion, status, fecha_termino
FROM nobo.agenda WHERE usuario='$varsesion'
and status not like'terminado'";
