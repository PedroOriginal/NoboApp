...
$where ="";
$sql = "SELECT id_usuario,Usuario_Corto,Nombre,Apellidos,correo FROM prueba2_nobo.usuarios";
              ...
              <tbody>
                ...
                {?>
                  <tr>
                    ...
                    <td><?php echo $row['Usuario_Corto']; ?></td>
                    <td><?php echo $row['Nombre']; ?></td>
                    <td><?php echo $row['Apellidos']; ?></td>
                    <td><?php echo $row['correo']; ?></td>
                    <td><a class="btn btn-primary btn-primary" href="modificar_usuario.php?id_usuario=<?php echo $row['id_usuario']; ?>">
                  Editar <i class='fas fa-pencil-alt'></i></a></td>
                    <td><a class="btn btn-danger btn-danger" href="" data-href="eliminar_usuario.php?id_usuario=<?php echo $row['id_usuario']; ?>"
                        data-toggle="modal" data-target="#confirme-delete">Eliminar <i class='fas fa-trash-alt'></i> </a></td>
                    </tr>
                  <?php }?>
              </tbody>
            </table>
